...
{
    public enum Types {BBOX, INTERSECTS, DWITHIN, WITHIN, CONTAINS};
    ...
    /**
     * The geometry to be used by the filter.  Use bounds for BBOX filters and geometry for INTERSECTS or DWITHIN filters.
    ...
    /**
     * The bounds to be used by the filter.  Use bounds for BBOX filters and geometry for INTERSECTS or DWITHIN filters.
